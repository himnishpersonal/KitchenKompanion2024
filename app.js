...
let foodItemsInUserRefrigerator = [
    new FoodItem('Carrots', '2025-11-01', 10, 'None'),
    new FoodItem('Broccoli', '2025-10-20', 5, 'None'),
    new FoodItem('Eggs', '2025-10-15', 12, 'None'),
    new FoodItem('Chicken Breast', '2025-10-17', 3, 'None'),
    new FoodItem('Tomatoes', '2025-10-18', 6, 'None'),
    new FoodItem('Cheese', '2025-11-05', 2, 'Dairy'),
    new FoodItem('Lettuce', '2025-11-01', 4, 'None'),
    new FoodItem('Salmon', '2025-10-18', 2, 'None'),
    new FoodItem('Bread', '2025-10-15', 5, 'Gluten'),
    new FoodItem('Milk', '2025-10-29', 2, 'Dairy'),
    new FoodItem('Yogurt', '2025-10-25', 6, 'Dairy'),
    new FoodItem('Butter', '2025-11-10', 1, 'Dairy'),
    new FoodItem('Spinach', '2025-10-14', 3, 'None'),
    new FoodItem('Ground Beef', '2025-10-19', 4, 'None'),
    new FoodItem('Shrimp', '2025-10-20', 2, 'Shellfish'),
    new FoodItem('Apples', '2025-10-15', 8, 'None'),
    new FoodItem('Grapes', '2025-10-16', 5, 'None'),
    //expired zone
...
function toggleFav(recipeId) {
    const recommendedRecipes = JSON.parse(localStorage.getItem('recommendedRecipes'));
    const recipe = recommendedRecipes[recipeId];
